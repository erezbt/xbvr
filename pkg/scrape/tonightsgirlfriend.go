...
func NaughtyAmericaVR(wg *sync.WaitGroup, updateSite bool, knownScenes []string, out chan<- models.ScrapedScene) error {
	...
	sceneCollector.OnHTML(`html`, func(e *colly.HTMLElement) {
		...
		// Title
		sc.Title = strings.TrimSpace(e.ChildText(`p.text-center a.title`)) + " - " + strings.TrimSpace(e.ChildText(`Title`))

		// Date
		e.ForEach(`span.scenepage-date`, func(id int, e *colly.HTMLElement) {
		...
		// Synopsis
		e.ForEach(`div.scenepage-description`, func(id int, e *colly.HTMLElement) {
	...
	siteCollector.OnHTML(`div[class=panel-body] div[class=scene-thumbnail] a`, func(e *colly.HTMLElement) {
	...
	siteCollector.Visit("https://www.tonightsgirlfirend.com/scenes/vr")
...
func init() {
	registerScraper("tonightsgirlfriend", "Tonight's Girlfriend VR", "https://mcdn.vrporn.com/files/20200404124349/TNGF_LOGO_BLK.jpg", NaughtyAmericaVR)
}
